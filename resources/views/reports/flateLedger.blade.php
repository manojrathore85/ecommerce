        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <form action="{{ url('report\flate-ledger') }}" method="POST">
                        @csrf
                            ...
                            @if ($data)
                                @foreach ($data as $key => $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->name }}</td>
                                        <td><a href="{{ url("flate/{$row->flate_id}/edit") }}">
                                                @if ($key > 0)
                                                    <span class="badge text-bg-primary">{{ $row->flate }}</span>
                                            </a>
                                @endif
                                </td>
